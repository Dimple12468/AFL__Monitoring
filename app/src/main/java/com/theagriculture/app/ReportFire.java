...
import com.theagriculture.app.Ado.CheckInActivity2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageUploadFragment abc = new ImageUploadFragment();
                abc.setArguments(bundle);
                AppCompatActivity activity = (AppCompatActivity) v.getContext();
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.for_images,abc).addToBackStack(null).commit();

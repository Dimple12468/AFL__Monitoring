            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String dlocation_address = singleObject.getString("village_name").toUpperCase() + "," + singleObject.getString("block_name").toUpperCase() + ", " +
...
//                        JSONObject authado = mAdoObject.getJSONObject("auth_user");
                        String auth_ado ;               //= authado.getString("pk");

//                        JSONObject mDdaObject = singleObject.getJSONObject("dda");
                        String ddaName ;                    //= mDdaObject.getString("name");
//                        JSONObject authddo = mDdaObject.getJSONObject("auth_user");
                        String auth_ddo ;                   //= authddo.getString("pk");

                        try {
                            JSONObject adoobj = singleObject.getJSONObject("ado");
                            JSONObject authado = adoobj.getJSONObject("auth_user");
                            auth_ado = authado.getString("pk");
...
//                            mpkdda.add("null");
                        ...
                        try {
                            JSONObject mDdaObject = singleObject.getJSONObject("dda");
                              ddaName = mDdaObject.getString("name");
...
//                            mDdaName.add("Not Assigned");
                        ...
                        try {
                            JSONObject mAdoObject = singleObject.getJSONObject("ado");
                            adoName = mAdoObject.getString("name");

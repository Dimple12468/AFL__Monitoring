...
public class Images_activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.app__bar_images);
...
//        }
        ...
        recyclerView = findViewById(R.id.review_pics);
        mImagesUrl = new ArrayList<>();
        adapter = new ReviewPicsRecyclerviewAdapter(this, mImagesUrl);//Recycler view for images
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(Images_activity.this,"An exception occured",Toast.LENGTH_LONG).show();
                            e.printStackTrace();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            final BottomSheetDialog mBottomDialogNotificationAction = new BottomSheetDialog(Images_activity.this);
//                            View sheetView = getActivity().getLayoutInflater().inflate(R.layout.no_internet, null);
                            LayoutInflater li = LayoutInflater.from(Images_activity.this);
                            ...
                            close.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (!doubleBackToExitPressedOnce) {
                                        ...
                                        Toast toast = Toast.makeText(Images_activity.this,"Tap on Close App again to exit app", Toast.LENGTH_LONG);
                            ...
                            Toast.makeText(Images_activity.this, "This error is case2", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ServerError) {
                            //Indicates that the server responded with a error response
                            Toast.makeText(Images_activity.this, "This error is case3", Toast.LENGTH_LONG).show();
                        } else if (error instanceof NetworkError) {
                            //Indicates that there was network error while performing the request
                            Toast.makeText(Images_activity.this, "This error is case4", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ParseError) {
                            // Indicates that the server response could not be parsed
                            Toast.makeText(Images_activity.this, "This error is case5", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(Images_activity.this, "An unknown error occurred.", Toast.LENGTH_SHORT).show();
                        }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                SharedPreferences prefs = Images_activity.this.getSharedPreferences("tokenFile", Context.MODE_PRIVATE);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Images_activity.this);

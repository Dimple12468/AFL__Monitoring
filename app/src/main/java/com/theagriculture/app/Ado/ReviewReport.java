...
//    private TextView khasraRight;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            editor.clear();
            editor.commit();
            Intent intent = new Intent(ReviewReport.this, login_activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.review_bar);
...
//        khasraRight = findViewById(R.id.khasraRight);
      ...
      //  progressBar = findViewById(R.id.progressBar);
        ...
        review_address_big = intent.getStringExtra("review_address_top");
        review_address_top.setText(review_address_big);//address of the incident
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            //String review_address_title = rootObject.getString("review_address_top");
                            ...
                            //review_address_top.setText(capitalCase(review_address_title));

...
public class AdoDdoCompleted_activity extends AppCompatActivity {
    ...
    private String TAG = "AddoDdoCompleted";
    String mUrl;
    ...
    public AdoDdoCompleted_activity() {
        // Required empty public constructor
    }


    public AdoDdoCompleted_activity(String mDdoId, boolean isDdo) {
        this.mDdoId = mDdoId;
        this.isDdo = isDdo;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_ddo_completed);
        Log.d(TAG,"in onCreate: ");

        spinner = findViewById(R.id.Ddo_completed_loading_json);
        spinner.setVisibility(View.VISIBLE);
        swipeRefreshLayout = findViewById(R.id.refreshpull5);
...
//                getFragmentManager().beginTransaction().detach(AdoDdoCompleted.this).attach(AdoDdoCompleted.this).commit();
        ...
        progressBar = findViewById(R.id.Ddo_completed_loading);
        recyclerView = findViewById(R.id.Ddo_completed_recyclerview);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if(resultsArray.length()== 0){
                                ...
                                //todo image
                                AdoDdoCompleted_activity.this.getLayoutInflater().inflate(R.layout.fragment_nothing_toshow, null);
...
//                                activity.getSupportFragmentManager().beginTransaction().replace(R.id.change_when_nodata, no_data).commit();
                            ...
                            spinner.setVisibility(View.GONE);
                            Toast.makeText(AdoDdoCompleted_activity.this,"An exception occurred",Toast.LENGTH_LONG).show();
                            e.printStackTrace();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            final BottomSheetDialog mBottomDialogNotificationAction = new BottomSheetDialog(AdoDdoCompleted_activity.this);
                            View sheetView = AdoDdoCompleted_activity.this.getLayoutInflater().inflate(R.layout.no_internet, null);
                            ...
                            close.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (!doubleBackToExitPressedOnce) {
                                        ...
                                        Toast toast = Toast.makeText(AdoDdoCompleted_activity.this, "Tap on Close App again to exit app", Toast.LENGTH_LONG);
                            ...
                            Toast.makeText(AdoDdoCompleted_activity.this, "This error is case2", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ServerError) {
                            //Indicates that the server responded with a error response
                            Toast.makeText(AdoDdoCompleted_activity.this, "This is a server error", Toast.LENGTH_LONG).show();
                        } else if (error instanceof NetworkError) {
                            //Indicates that there was network error while performing the request
                            Toast.makeText(AdoDdoCompleted_activity.this, "This error is case4", Toast.LENGTH_LONG).show();
                        } else if (error instanceof ParseError) {
                            // Indicates that the server response could not be parsed
                            Toast.makeText(AdoDdoCompleted_activity.this, "This error is case5", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(AdoDdoCompleted_activity.this, "An unknown error occurred.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            if(error instanceof TimeoutError || error instanceof NoConnectionError){
                                ...
                                Toast.makeText(AdoDdoCompleted_activity.this,"An error occured",Toast.LENGTH_LONG).show();
                            }

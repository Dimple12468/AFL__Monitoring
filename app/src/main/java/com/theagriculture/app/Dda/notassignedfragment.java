...
public class notassignedfragment extends Fragment {
    ...
    private String urlget = Globals.unassignedLocationsDDA;                           //"http://18.224.202.135/api/locations/dda/assigned";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(resultsArray.length()== 0){
                                ...
                                //Toast.makeText(getActivity(),"enterd array zero condition",Toast.LENGTH_LONG).show();
                                recyclerViewAdater.notifyDataSetChanged();
                                //Toast.makeText(getActivity(),"notified adapter",Toast.LENGTH_LONG).show();
